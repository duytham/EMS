...
if (isset($_SESSION['user_id']) && isset($_SESSION['role_id']) && isset($_SESSION['email'])) {
    // Lấy email và role từ session
    $userEmail = $_SESSION['email'];
    $role = '';

    // Đặt tên role dựa trên role_id trong session
    ...
    // Nếu người dùng chưa đăng nhập, đặt mặc định
    $userEmail = "Guest";
    $role = "Guest";
}
?>
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">
                    <?php echo htmlspecialchars($userEmail . " (" . $role . ")"); ?>
                </span>
